...
public class PlayerData {
    private Team team;
    private String role;
    private int money, health, kills, killsInARow, deaths, deathsInARow, moveChecker, pointsCaptured, pointsDefended, foodLevel;
	...
	public void setPointsDefended(int pointsDefended) {
		this.pointsDefended = pointsDefended;
	}
}
